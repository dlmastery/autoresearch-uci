...
**Honest audit after Exp93:** this project did **not** follow the original skill through Exp31; isolation resumed at Exp32. LightGBM cycle is 50/50. Isolated CatBoost is 19/50.
...
| catboost | 21, 26, 77–93 (19) | Prokhorenkova 2018 rsm; Ke 2017; Zheng 2013; Tie 2017 RH | No |
...
Isolation: LightGBM cycle is **50/50 complete**. Isolated CatBoost is **19/50** (1h champion still Exp30; t+6 recipe Exp76). Snapshot `code_versions/catboost_start/`.
...
64. **Stay on Exp91. Do not retry rsm=0.6 / l2=10 / month_sin / accel / Lossguide. Leave 0.052 NEAR-MISS. Do not start MLP.** ← **next**
