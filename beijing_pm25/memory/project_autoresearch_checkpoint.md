# Autoresearch checkpoint — after Exp202 DISCARD (1h remains Exp192; FT 28/50; t+6 Exp76)
...
- **NEW:** heating Iws<2 persist>=150 n=333 RMSE **38.43** vs persist **37.04** (14.79% of SSE; need **+0.45** pred_d **−4.81**). Winter calm mega-haze loses to persist; Exp167 was 34.88 / −1.64.
- **Exp202 DISCARD** FT Pre-LN lr=5e-5 on Exp192. Val **22.654** missed 21.948 (outside 21.70–22.40). Test **21.549** missed 20.453 (outside 20.20–21.20). heating Iws<2 persist>=150 pred_d −4.81→**−6.68** RMSE 38.43→**45.17**. Typical 7.54→**8.53**. Global bias −0.07→**−1.82**. Keep lr 1e-4.

## This fire
- **Exp202 DISCARD** FT Pre-LN lr=5e-5 (isolated cycle 28/50). 1h champion remains Exp192. FT **28/50**. FT val recipe remains Exp192.
