...
## This fire (2026-08-22, Exp189)

New diagnosis: hour7 persist>=80 n=173 RMSE **21.55 vs persist 28.55** (2.51% of Exp167 SSE; need **−6.84** pred_d **−3.53**). Rush-hour dirty hours under-clean; Exp186 pred_d −5.63. January 31.22 vs JJA 13.87. Hour 20 32.68 vs persist 33.24. Onset 110.28 vs persist 107.80. Val 21.972 vs test 20.072 is the bottleneck.

**Exp189 DISCARD** FT Pre-LN add is_morning on Exp186. Val **22.258** missed Exp167 21.972 and Exp186 22.066 (inside 21.70–22.40). Test **20.724** missed Exp167 20.072 and Exp186 20.483 (inside 20.20–21.20). Prediction HIT. hour7 persist>=80 21.55→**23.38**; pred_d −3.53→**−1.42** vs Exp186 −5.63 versus need −6.84 (under-clean worsened). Typical 7.14→**7.74**. January 31.22→**33.45**. Global bias **+1.31**. Token blocked morning washout. **FT is_morning closed.** Third extra-token DISCARD — rethink feature class. Recipe stays Exp186.

1h champion unchanged: Exp167. FT **15/50**. FT val recipe remains Exp186. t+6 recipe remains Exp76.

## This fire (2026-08-22, Exp190)

New diagnosis: lag1-roll3>=20 n=463 RMSE **36.31 vs persist 41.10** (19.06% of Exp167 SSE; need **+3.46** pred_d **+1.64**). Post-spike hours still rise; Exp186 reverses pred_d −0.23. January 31.22 vs JJA 13.87. Hour 20 32.68 vs persist 33.24. Onset 110.28 vs persist 107.80. Val 21.972 vs test 20.072 is the bottleneck.

**Exp190 DISCARD** FT Pre-LN add pm25_roll3mean on Exp186. Val **22.354** missed Exp167 21.972 and Exp186 22.066 (inside 21.70–22.40). Test **20.702** missed Exp167 20.072 and Exp186 20.483 (inside 20.20–21.20). Prediction HIT. lag1-roll3>=20 pred_d +1.64→**+2.08** vs Exp186 −0.23 versus need +3.46 (sign corrected) but RMSE 36.31→**36.80**. Typical 7.14→**7.92**. persist>=200 |need|<=10 14.09→**21.49**. January 31.22→**33.94**. Global bias **−0.59**. **FT pm25_roll3mean closed.** Recipe stays Exp186.

1h champion unchanged: Exp167. FT **16/50**. FT val recipe remains Exp186. t+6 recipe remains Exp76.

## This fire (2026-08-22, Exp191)

New diagnosis: Iws>=100 n=323 RMSE **5.71 vs persist 5.40** (0.33% of Exp167 SSE; need **−0.32** pred_d **+0.08**). Storm hours easy; Exp186 over-cleans pred_d −1.37. January 31.22 vs JJA 13.87. Hour 20 32.68 vs persist 33.24. Onset 110.28 vs persist 107.80. Val 21.972 vs test 20.072 is the bottleneck.

**Exp191 DISCARD** FT Pre-LN add iws_clip100 on Exp186. Val **22.354** missed Exp167 21.972 and Exp186 22.066 (inside 21.70–22.40). Test **20.946** missed Exp167 20.072 and Exp186 20.483 (inside 20.20–21.20). Prediction HIT. Iws>=100 pred_d +0.08→**−0.68** vs Exp186 −1.37 versus need −0.32 (over-clean damped) but RMSE 5.71→**5.58** vs Exp186 5.51. Typical 7.14→**7.64**. January 31.22→**34.50**. Global bias **+0.47**. **FT iws_clip100 closed.** Recipe stays Exp186.

1h champion unchanged: Exp167. FT **17/50**. FT val recipe remains Exp186. t+6 recipe remains Exp76.

## This fire (2026-08-22, Exp192)

New diagnosis: heating RH>=70 Iws<5 persist>=80 n=245 RMSE **31.59 vs persist 31.57** (7.63% of Exp167 SSE; need **+0.86** pred_d **−1.09**). Winter moist-calm dirty hours have zero skill; Exp186 over-cleans pred_d −3.65 RMSE 33.10. January 31.22 vs JJA 13.87. Hour 20 32.68 vs persist 33.24. Onset 110.28 vs persist 107.80. Val 21.972 vs test 20.072 is the bottleneck.

**Exp192 KEEP** FT Pre-LN add rh_iws on Exp186. Val **21.948** beat Exp167 21.972 and Exp186 22.066 (inside 21.70–22.40). Test **20.453** missed Exp167 20.072 but beat Exp186 20.483 (inside 20.20–21.20). Composite **−21.948** beat −21.972. Prediction HIT. heating RH>=70 Iws<5 persist>=80 pred_d −1.09→**−3.84** vs Exp186 −3.65 versus need +0.86 (over-clean worsened) RMSE 31.59→**33.54**. Typical 7.14→**7.54**. January 31.22→**33.22**. Global bias −0.29→**−0.07**. Slice missed; val-side KEEP. **First FT KEEP versus Exp167. New 1h champion Exp192.**

1h champion is now Exp192. FT **18/50**. FT val recipe is Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-22, Exp193)

New diagnosis: January SE persist>=80 n=107 RMSE **53.54 vs persist 54.25** (9.22% of Exp192 SSE; need **+6.42** pred_d **−2.22**). Winter dirty southerly hours have the wrong sign, treated like NW cleanout. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp193 DISCARD** FT Pre-LN add se_iws on Exp192. Val **22.265** missed Exp192 21.948 (inside 21.70–22.40). Test **20.633** missed Exp192 20.453 (inside 20.20–21.20). Prediction HIT. January SE persist>=80 pred_d −2.22→**−3.65** versus need +6.42 (over-clean worsened) RMSE 53.54→**57.14**. Typical 7.54→**7.84**. January 33.22→**34.53**. Global bias −0.07→**−0.49**. **FT se_iws closed.** Recipe stays Exp192.
...
## This fire (2026-08-22, Exp195)

New diagnosis: January delta6>20 n=255 RMSE **44.94 vs persist 43.23** (15.49% of Exp192 SSE; need **+2.95** pred_d **−5.67**). Winter still-building 6h episodes have the wrong sign. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp195 DISCARD** FT Pre-LN add pm25_delta6 on Exp192. Val **22.313** missed Exp192 21.948 (inside 21.70–22.40). Test **20.699** missed Exp192 20.453 (inside 20.20–21.20). Prediction HIT. January delta6>20 pred_d −5.67→**−5.96** versus need +2.95 (over-clean worsened) RMSE 44.94→**45.31**. Typical 7.54→**7.95**. January 33.22→**33.70**. Global bias −0.07→**−0.45**. **FT pm25_delta6 closed.** Three extra-token DISCARDs after KEEP — rethink. Recipe stays Exp192.

1h champion unchanged: Exp192. FT **21/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-22, Exp196)

New diagnosis: need>=30 accel<=0 n=121 RMSE **80.99 vs persist 78.35** (23.86% of Exp192 SSE; need **+55.19** pred_d **−1.01**). Second-diff token sign-flips at inflections. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp196 DISCARD** FT Pre-LN drop pm25_accel keep delta1 on Exp192. Val **23.277** missed Exp192 21.948 (outside 21.70–22.40). Test **21.638** missed Exp192 20.453 (outside 20.20–21.20). Prediction MISS. need>=30 accel<=0 pred_d −1.01→**+2.31** versus need +55.19 (sign flipped) RMSE 80.99→**79.80**. Typical 7.54→**8.42**. January 33.22→**34.19**. Onset 110.79→**107.33**. Bomb mean improved; 2013 val collapsed. **FT drop-accel closed. Keep accel.** Recipe stays Exp192.
...
## This fire (2026-08-22, Exp198)

New diagnosis: inv<3 persist>=80 n=628 RMSE **19.78 vs persist 21.46** (7.39% of Exp192 SSE; need **−1.59** pred_d **−0.13**). Moist near-saturated dirty hours under-clean. inversion_spread correlates 1.0 with TEMP−DEWP and −0.95 with rh_magnus. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp198 DISCARD** FT Pre-LN drop inversion_spread keep TEMP DEWP on Exp192. Val **22.749** missed Exp192 21.948 (outside 21.70–22.40). Test **21.406** missed Exp192 20.453 (outside 20.20–21.20). Prediction MISS. inv<3 persist>=80 pred_d −0.13→**−2.73** RMSE 19.78→**20.17**. Typical 7.54→**8.66**. January 33.22→**36.01**. Global bias −0.07→**−3.19**. **FT drop inversion_spread closed. Keep inversion_spread.** Three collinear-drop DISCARDs — rethink. Recipe stays Exp192.

1h champion unchanged: Exp192. FT **24/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-22, Exp199)

New diagnosis: typical persist>=80 n=1774 RMSE **10.78 vs persist 5.70** (6.20% of Exp192 SSE; need **+0.53** pred_d **−0.07**). Dirty-but-stable hours almost 2× persist; Exp167 was 9.59. Val 21.948 vs test 20.453 (gap 1.50) is the bottleneck. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80.

**Exp199 DISCARD** FT Pre-LN patience=8 on Exp192. Val **22.737** missed Exp192 21.948 (outside 21.70–22.40). Test **21.196** missed Exp192 20.453 (inside 20.20–21.20). Prediction MISS. typical persist>=80 10.78→**11.52**. Typical 7.54→**7.97**. January 33.22→**36.02**. Onset 110.79→**112.76**. Earlier stop underfit. **FT patience=8 closed. Keep patience=15.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **25/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-22, Exp200)

New diagnosis: need 20-50 n=515 RMSE **29.68 vs persist 30.83** (13.64% of Exp192 SSE; need **+29.90** pred_d **+2.42**). Moderate jumps capture 8% of the rise; Exp167 was 28.91 / +3.31; patience=8 made 31.51 / +0.95. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp200 DISCARD** FT Pre-LN patience=25 on Exp192. Val **22.010** missed Exp192 21.948 by 0.062 (inside 21.70–22.40 and ±0.08 noise). Test **20.402** beat Exp192 20.453 (inside 20.20–21.20). Prediction HIT. need 20-50 pred_d +2.42→**+1.43** RMSE 29.68→**30.83**. Typical 7.54→**7.42**. January 33.22→**33.15**. Global bias −0.07→**−1.15**. Later cosine did not lift moderate jumps. **FT patience=25 closed. Keep patience=15.** Recipe stays Exp192.
...
## This fire (2026-08-23, Exp202)

New diagnosis: heating Iws<2 persist>=150 n=333 RMSE **38.43 vs persist 37.04** (14.79% of Exp192 SSE; need **+0.45** pred_d **−4.81**). Winter calm mega-haze over-cleans and loses to persist; Exp167 was 34.88 / −1.64. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp202 DISCARD** FT Pre-LN lr=5e-5 on Exp192. Val **22.654** missed Exp192 21.948 (outside 21.70–22.40). Test **21.549** missed Exp192 20.453 (outside 20.20–21.20). Prediction MISS. heating Iws<2 persist>=150 pred_d −4.81→**−6.68** versus need +0.45 (over-clean worsened) RMSE 38.43→**45.17**. Typical 7.54→**8.53**. January 33.22→**36.88**. Global bias −0.07→**−1.82**. Lower LR underfit and over-cleaned more. **FT lr=5e-5 closed. Keep lr 1e-4.** Recipe stays Exp192.
...
## This fire (2026-08-23, Exp204)

New diagnosis: PRES>=1025 persist>=150 n=413 RMSE **41.99 vs persist 40.56** (21.90% of Exp192 SSE; need **−3.20** pred_d **−10.12**). High-pressure dirty hours over-clean 3x and lose to persist; Exp167 was 38.29 / −8.97. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp204 DISCARD** FT Pre-LN weight_decay=1e-6 on Exp192. Val **22.290** missed Exp192 21.948 (inside 21.70–22.40). Test **20.528** missed Exp192 20.453 (inside 20.20–21.20). Prediction HIT. PRES>=1025 persist>=150 pred_d −10.12→**−6.62** versus need −3.20 (over-clean damped) RMSE 41.99→**41.35**. Typical 7.54→**7.39**. January 33.22→**33.64**. Global bias −0.07→**−0.72**. Weaker decay helped the slice but taxed val. **FT weight_decay=1e-6 closed. Keep wd 1e-5.** Recipe stays Exp192.
...
## This fire (2026-08-23, Exp208)

New diagnosis: TEMP<0 persist>=150 n=367 RMSE **37.12 vs persist 36.32** (15.20% of Exp192 SSE; need **−6.97** pred_d **−9.74**). Frozen mega-haze over-cleans and loses to persist; Exp167 was 33.79 / −9.49. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp208 DISCARD** FT Pre-LN activation=relu on Exp192. Val **22.458** missed Exp192 21.948 (outside 21.70–22.40). Test **20.992** missed Exp192 20.453 (inside 20.20–21.20). Prediction MISS on val/composite, HIT on test. TEMP<0 persist>=150 pred_d −9.74→**−10.92** versus need −6.97 RMSE 37.12→**39.30**. Typical 7.54→**8.09**. January 33.22→**35.09**. Global bias −0.07→**−3.33**. ReLU over-cleaned more. **FT activation=relu closed. Keep GELU.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **34/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-23, Exp209)

New diagnosis: cbwd_cv persist>=200 n=308 RMSE **31.65 vs persist 29.22** (9.28% of Exp192 SSE; need **+0.68** pred_d **−3.64**). Calm-variable mega-haze over-cleans and loses to persist; Exp167 was 28.41 / −0.33. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp209 DISCARD** FT Pre-LN LayerScale 0.1 on Exp192. Val **23.468** missed Exp192 21.948 (outside 21.70–22.40). Test **22.651** missed Exp192 20.453 (outside 20.20–21.20). Prediction MISS. cbwd_cv persist>=200 pred_d −3.64→**−8.04** versus need +0.68 RMSE 31.65→**42.75**. Typical 7.54→**10.08**. January 33.22→**39.96**. Global bias −0.07→**−4.88**. LayerScale over-cleaned more. **FT layer_scale=0.1 closed. Keep unscaled Pre-LN residuals.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **35/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-23, Exp210)

New diagnosis: month2 persist>=150 n=262 RMSE **34.48 vs persist 33.74** (9.36% of Exp192 SSE; need **−2.03** pred_d **−8.61**). February mega-haze over-cleans 4x and loses to persist; Exp167 was 32.79 / −6.70. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp210 DISCARD** FT Pre-LN drop_path=0.1 on Exp192. Val **22.628** missed Exp192 21.948 (outside 21.70–22.40). Test **21.142** missed Exp192 20.453 (inside 20.20–21.20). Prediction MISS on val/composite, HIT on test. month2 persist>=150 pred_d −8.61→**−11.24** versus need −2.03 RMSE 34.48→**35.34**. Typical 7.54→**8.16**. January 33.22→**36.76**. Global bias −0.07→**−0.38**. Stochastic depth over-cleaned more. **FT drop_path=0.1 closed. Keep all 3 Pre-LN blocks.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **36/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-23, Exp211)

New diagnosis: need>20 Iws>=10 n=138 RMSE **70.15 vs persist 68.21** (20.42% of Exp192 SSE; need **+43.26** pred_d **−0.12**). Windy jumps capture 0% of the rise and lose to persist; Exp167 was 70.38 / +0.67. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp211 DISCARD** FT Pre-LN n_heads=1 on Exp192. Val **22.490** missed Exp192 21.948 (outside 21.70–22.40). Test **20.961** missed Exp192 20.453 (inside 20.20–21.20). Prediction MISS on val/composite, HIT on test. need>20 Iws>=10 pred_d −0.12→**+1.48** versus need +43.26 RMSE 70.15→**69.63**. Typical 7.54→**7.50**. January 33.22→**34.11**. Onset pred_d −1.54→**+0.94**. Slice sign improved but val paid January. **FT n_heads=1 closed. Keep 4 heads.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **37/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-24, Exp212)

New diagnosis: cbwd_SE persist>=80 need>20 n=189 RMSE **61.14 vs persist 61.32** (21.24% of Exp192 SSE; need **+41.20** pred_d **+3.20**). Southerly jumps capture 8% of the rise and tie persist; Exp167 was 61.08 / +4.03. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp212 DISCARD** FT Pre-LN SAM rho=0.05 on Exp192. Val **22.281** missed Exp192 21.948 (inside 21.70–22.40). Test **21.080** missed Exp192 20.453 (inside 20.20–21.20). Prediction HIT. cbwd_SE persist>=80 need>20 pred_d +3.20→**+3.21** RMSE 61.14→**61.31**. Typical 7.54→**8.00**. January 33.22→**35.50**. Onset pred_d −1.54→**−0.90**. SAM left southerly jumps frozen. **FT SAM rho=0.05 closed. Keep AdamW.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **38/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-24, Exp213)

New diagnosis: cbwd_NW need>20 n=70 RMSE **57.41 vs persist 49.98** (6.94% of Exp192 SSE; need **+41.41** pred_d **−6.25**). Northerly jumps have the wrong sign and lose to persist; Exp167 was 57.83 / −7.09. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp213 DISCARD** FT Pre-LN loss=mse on Exp192. Val **22.665** missed Exp192 21.948 (outside 21.70–22.40). Test **21.067** missed Exp192 20.453 (inside 20.20–21.20). Prediction MISS on val/composite, HIT on test. cbwd_NW need>20 pred_d −6.25→**−7.70** versus need +41.41 RMSE 57.41→**57.04**. Typical 7.54→**8.45**. January 33.22→**34.47**. Global bias −0.07→**−3.52**. MSE over-cleaned more and biased low. **FT loss=mse closed. Keep smooth_l1.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **39/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## This fire (2026-08-24, Exp214)

New diagnosis: hour23 persist>=80 n=162 RMSE **25.95 vs persist 25.41** (3.28% of Exp192 SSE; need **+2.64** pred_d **−0.06**). Midnight dirty hours have the wrong sign and lose to persist; Exp167 was 23.27 / +1.89 and beats persist. January 33.22 vs JJA 14.12. Hour 20 32.69 vs persist 33.24. Onset 110.79 vs persist 107.80. Val 21.948 vs test 20.453 is the bottleneck.

**Exp214 DISCARD** FT Pre-LN final_ln=true on Exp192. Val **22.685** missed Exp192 21.948 (outside 21.70–22.40). Test **22.877** missed Exp192 20.453 (outside 20.20–21.20). Prediction MISS. hour23 persist>=80 pred_d −0.06→**−1.18** versus need +2.64 RMSE 25.95→**31.62**. Typical 7.54→**10.03**. January 33.22→**41.32**. Global bias −0.07→**−1.04**. Final LN over-cleaned more. **FT final_ln closed. Keep Pre-LN without a final LN.** Recipe stays Exp192.

1h champion unchanged: Exp192. FT **40/50**. FT val recipe remains Exp192. t+6 recipe remains Exp76.

## Next (original process)

1. Isolate **FT-Transformer** (40/50) from Exp192 Pre-LN + cbwd_prev_NW + rh_iws. Do not retry final_ln or nearby RMSNorm/head-LN. Keep Pre-LN without a final LN. Do not retry loss=mse or nearby Huber beta 0.5/2/5/10 or MAE. Keep smooth_l1 beta=1. Do not retry sam_rho 0.05/0.01/0.1/0.2. Keep AdamW. Do not retry n_heads=1/3/16 (2/8 already closed as persist fix). Keep 4 heads. Do not retry drop_path 0.1/0.05/0.2/0.3. Keep all 3 Pre-LN blocks. Do not retry layer_scale 0.1/0.01/0.05/1e-4. Keep unscaled Pre-LN residuals. Do not retry activation=relu/silu/relu6. Keep GELU. Do not retry feature_tokenizer=per_feature or per-column Linear variants. Keep shared Linear(1,d). Do not retry pooling=mean/max/sum. Keep CLS pooling. Do not retry num_embedding=periodic or n_frequencies 8/32. Keep linear tokenizer. Do not retry wd 1e-6/5e-6/2e-6 or 5e-5/2e-4/0/1e-4. Keep wd 1e-5. Do not retry ff_factor 3/4/6/8. Keep 2d FFN. Do not retry lr 5e-5/3e-5/7e-5 or 2e-4/3e-4/5e-4. Keep lr 1e-4. Do not retry batch 16/8/24 or 48/64/128. Do not retry patience {5,8,10,12,20,25,30}. Keep batch 32, patience=15, inversion_spread, is_weekend, pm25_accel. Do not drop another derived column. Do not add another unused extra column. Do not retry drop-inv/drop-weekend/drop-accel/pm25_delta6/is_severe/se_iws. Do not retry heating_night/pres_delta/is_morning/evening_peak/pm25_roll3mean/iws_clip100. Do not retry warmup 15/25. Do not retry dropout 0/0.2. Do not revert Post-LN. Do not mix MLP HPs into FT. Next fire must diagnose a NEW slice and pick a legal unused axis (GEGLU FFN), not another final-LN/loss/SAM/n_heads/drop_path/LayerScale/activation/tokenizer/pooling/periodic/wd/FFN-widen/lr/batch/patience/drop/extra-token.
