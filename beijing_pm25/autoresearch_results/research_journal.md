...
84 DISCARDs on the 1h gate. t+6 side-KEEPs: Exp46, Exp47, Exp55, Exp56, Exp59, Exp68, Exp70, Exp72, Exp75 rh_magnus, **Exp76** linear_lambda=1 (val 57.16 / test 54.31). CatBoost Exp91 rh_magnus NEAR-MISS val **22.449**; Exp93 rsm=0.8 test-tied Exp30, val 22.569 missed.
...
2. Do not retry rsm=0.6 / l2=10 / month_sin / accel / Lossguide
3. Leave the 0.052 NEAR-MISS or a non-subsample rethink. Do not start MLP
