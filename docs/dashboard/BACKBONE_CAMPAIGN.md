...
**Honest audit after Exp102:** this project did **not** follow the original skill through Exp31; isolation resumed at Exp32. LightGBM cycle is 50/50. Isolated CatBoost is 28/50. **1h champion remains Exp97 CatBoost.**
...
| catboost | 21, 26, 77–102 (28) | Prokhorenkova 2018 Depthwise DISCARD; Tie 2017; Huang 2014; Cai 2017 | No |
...
Isolation: LightGBM cycle is **50/50 complete**. Isolated CatBoost is **28/50** (**1h champion Exp97 CatBoost**; t+6 recipe Exp76). Snapshot `code_versions/catboost_start/`.
...
73. **Stay on Exp97 SymmetricTree. Do not retry Depthwise max_leaves. Do not start MLP.** ← **next**
