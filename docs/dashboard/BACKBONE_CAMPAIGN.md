...
**Honest audit after Exp100:** this project did **not** follow the original skill through Exp31; isolation resumed at Exp32. LightGBM cycle is 50/50. Isolated CatBoost is 26/50. **1h champion remains Exp97 CatBoost.**
...
| catboost | 21, 26, 77–100 (26) | Prokhorenkova 2018; Tie 2017; Huang 2014; Cai 2017 Nature rh_iws | No |
...
Isolation: LightGBM cycle is **50/50 complete**. Isolated CatBoost is **26/50** (**1h champion Exp97 CatBoost**; t+6 recipe Exp76). Snapshot `code_versions/catboost_start/`.
...
71. **Stay on Exp97. Do not retry stagn_index / heating_day / T=5. Moist-calm persist leftover needs a non-ratio rethink. Do not start MLP.** ← **next**
