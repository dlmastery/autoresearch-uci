...
**Honest audit after Exp101:** this project did **not** follow the original skill through Exp31; isolation resumed at Exp32. LightGBM cycle is 50/50. Isolated CatBoost is 27/50. **1h champion remains Exp97 CatBoost.**
...
| catboost | 21, 26, 77–101 (27) | Prokhorenkova 2018; Tie 2017; Huang 2014; Cai 2017 | No |
...
Isolation: LightGBM cycle is **50/50 complete**. Isolated CatBoost is **27/50** (**1h champion Exp97 CatBoost**; t+6 recipe Exp76). Snapshot `code_versions/catboost_start/`.
...
72. **Stay on Exp97. Rethink architecture: grow_policy=Depthwise. Do not retry another is_heating product. Do not start MLP.** ← **next**
